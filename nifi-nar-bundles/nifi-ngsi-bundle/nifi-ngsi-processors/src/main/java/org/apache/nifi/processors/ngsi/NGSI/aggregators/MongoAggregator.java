...
public abstract class MongoAggregator {
        ...
        public void initialize(NGSIEvent event,String dataModel) {
            this.event=event;
            this.dataModel=dataModel;
        } // initialize

        public abstract void aggregate(NGSIEvent event,String dataModel);
    ...
    public class RowAggregator extends MongoAggregator {
        ...
        @Override
        public void initialize(NGSIEvent event,String dataModel) {
            super.initialize(event,dataModel);
        } // initialize

        @Override
        public void aggregate(NGSIEvent event,String dataModel) {
            // get the event headers
            long notifiedRecvTimeTs = event.getCreationTime();
            // get the event body
            String entityId = event.getEntityId();
            String entityType = event.getEntityType();
            // iterate on all this context element attributes, if there are attributes
            ArrayList<Attributes> contextAttributes = event.getAttrs();
    ...
    public class ColumnAggregator extends MongoAggregator {
        ...
        @Override
        public void aggregate(NGSIEvent event,String dataModel) {
            long recvTimeTs = event.getCreationTime();
